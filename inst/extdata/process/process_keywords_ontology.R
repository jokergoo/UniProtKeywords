...
file.remove("keywlist.txt")
system2("wget https://ftp.uniprot.org/pub/databases/uniprot/current_release/knowledgebase/complete/docs/keywlist.txt")

ln = readLines("keywlist.txt")
...
file.remove("uniprot_sprot.dat.gz")
system2("wget https://ftp.uniprot.org/pub/databases/uniprot/current_release/knowledgebase/complete/uniprot_sprot.dat.gz")
